...
local btnMenu, btnVoltar, btnSom, btnSair
...
function scene:show( event )
   ...
   elseif ( phase == "did" ) then
       ...
       btnSom:addEventListener( "tap", pausaSom )
        ...
        btnMenu:addEventListener( "tap", telaMenu )
        btnVoltar:addEventListener( "tap", telaRegras2 )
...
function configuraBotoes()
    ...
    btnMenu = display.newImage("graficos/botoes/btnInicio.png")
    btnMenu.xScale = .7
    btnMenu.yScale = .7
    btnMenu.x = largura - 80
    btnMenu.y = altura - 145
    scene.view:insert(btnMenu)
...
function configuraPainel()
    ...
    local painel = display.newImage( "graficos/componentes/painelRegras3.png", centroX - 90, centroY - 30)
        painel.xScale = .60
        painel.yScale = .55
...
function telaRegras2()
    ...
    composer.gotoScene( "regras2", transicaoParaEsquerda )
end
